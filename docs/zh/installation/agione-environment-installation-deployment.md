...
将 `agione-bundle-set-v1.0-260501.tar.gz` 上传到目标主机，例如：

```bash
scp -r agione-bundle-set-v1.0-260501.tar.gz root@<target-host>:/opt/hyperone/
ssh root@<target-host>
cd /opt/hyperone && \
tar -zxvf agione-bundle-set-v1.0-260501.tar.gz && \
cd /opt/hyperone/agione-bundle-set-v1.0-260501
```
...
| 类型 | 路径 |
| --- | --- |
| bundle 解包源目录 | `agione-bundle-set-*` |
