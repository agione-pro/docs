...
| --- | --- | --- | --- | --- |
| AI Infra On-Prem | Regions, availability zones, clusters, nodes, and accelerator management | Supported | Compatible infrastructure is prepared and authorized | [Regions & Zones](../../usermanual/ai-infra-on-prem/operator/resource-pools/regions-zones/) |
| AI Infra On-Prem | Specifications, images, storage, and templates | Supported | Required backend resources and templates are configured | [Resource Specs](../../usermanual/ai-infra-on-prem/operator/resource-pools/resource-specs/) |
| AI Infra On-Prem | Development environments, training jobs, and online inference | Supported | Quota, image, storage, accelerator, and template requirements are met | [User Overview](../../usermanual/ai-infra-on-prem/user/overview/) |
| AI Infra On-Prem | Quotas, credits, metering, usage, and monitoring | Supported | Data visibility depends on role, tenant, and collection status | [Usage](../../usermanual/ai-infra-on-prem/user/quotas-usage/usage/) |
| AI Infra On-Cloud | Cloud platform, account, resource-pool, and authorization management | Supported | Only configured and validated platform types are usable | [Access Overview](../../usermanual/ai-infra-on-cloud/operator/access-workbench/access-overview/) |
| AI Infra On-Cloud | Frameworks, models, runtime images, and scheduling policies | Supported | Assets and policies must match the target cloud platform and region | [Models](../../usermanual/ai-infra-on-cloud/operator/deploy-assets/models/) |
...
| Model Services | Meta-models, sources, templates, tags, and currency settings | Supported | Operator permission and valid base configuration are required | [Meta Models](../../usermanual/model-services/operator/settings/meta-models/) |
...
| Model Services | Aggregate-model publishing and routing | Supported | Performed by a model provider using eligible member models and available strategies | [My Models](../../usermanual/model-services/user/studio/my-models/) |
| Model Services | Model and app review | Supported | Performed by an operator; publication state affects user visibility | [Model Reviews](../../usermanual/model-services/operator/approvals/model-reviews/) |
| Model Services | Model discovery and Playground | Supported | A visible, reviewed, and usable model is required; modality depends on the model | [Models](../../usermanual/model-services/user/discover/models/) |
| Model Services | Model-specific API access and call records | Supported | Valid access, endpoint, credentials, quota, and model availability are required | [My Calls Overview](../../usermanual/model-services/user/my-calls/overview/) |
| Model Services | Usage, customer calls, and model revenue | Supported | Scope and freshness depend on role, metering, and synchronization | [Model Usage](../../usermanual/model-services/user/usage-earnings/model-usage/) |
| Billing | User billing, transactions, top-up orders, monthly bills, and quota governance | Supported | Scope depends on account, tenant, billing cycle, and synchronization status | [Account Overview](../../usermanual/billing/user/billing/overview/) |
| Billing | Customer finance, finance operations, settlement, reconciliation, and account adjustment | Supported | Operator permission, billing-cycle consistency, and source-record synchronization are required | [Reconciliation Center](../../usermanual/billing/operator/finance-operations/reconciliation-center/) |
...
| Settings | Personal Keys, profile, projects, members, roles, and tenants | Supported | Visibility depends on role, tenant scope, and menu authorization | [Dashboard](../../usermanual/settings/user/personal/dashboard/) |
| Settings | Platform settings, login properties, operation logs, and audit records | Supported | Platform or security administration permission is required for high-risk changes | [Platform Settings](../../usermanual/settings/operator/system-settings/platform-settings/) |
