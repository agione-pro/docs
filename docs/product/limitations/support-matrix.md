...
| Billing | User billing, transactions, top-up orders, monthly bills, and quota governance | Supported | Scope depends on account, tenant, billing cycle, and synchronization status | [Billing User Manual](../../usermanual/billing/) |
...
| Settings | Personal Keys, profile, projects, members, roles, and tenants | Supported | Visibility depends on role, tenant scope, and menu authorization | [Settings User Manual](../../usermanual/settings/) |
