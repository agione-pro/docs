...
![查看收益概览](./images/manual-earnings-overview.png)
...
1. 点击 **"收益详情"**。
2. 设置时间范围，并按页面可用条件查询目标记录。
3. 核对记录时间、模型、业务对象和收益数值。
4. 用于共享或对账时，先移除用户名称、业务标识和其他敏感信息。

![查询收益详情](./images/manual-earning-details.png)

上图展示详情查询区和结果列表。重点核对时间范围、筛选条件和结果口径。

![模型收益详情参考](./images/model-earnings-earning-details-list.png)
