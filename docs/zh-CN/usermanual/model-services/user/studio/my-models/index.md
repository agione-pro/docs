...
![查看我的发布](./images/manual-my-published.png)
...
![查看我的聚合](./images/manual-my-aggregate.png)
...
![打开发布模型入口](./images/manual-publish-model-entry.png)

上图展示发布区域选择入口。先确认私有区或公共区，再进入发布向导。

![选择发布区域](./images/my-published-choose-where-to-publish-add.png)

确认发布区域与目标可见范围一致。

![填写发布基础信息](./images/my-published-basic-information-add.png)

核对模型名称、来源和展示信息。

![配置模型计费](./images/my-published-billing-configuration-add.png)

核对计费单位、价格和免费额度。

![配置模型限流](./images/my-published-rate-limit-configuration-add.png)
...
![打开创建聚合模型入口](./images/manual-create-aggregate-entry.png)

上图展示聚合模型区域选择入口。先确认可见范围，再进入创建向导。

![选择聚合模型区域](./images/my-aggregate-choose-where-to-publish-add.png)

确认聚合模型区域和客户范围。

![填写聚合模型信息](./images/my-aggregate-basic-information-add.png)

核对名称、候选模型和路由策略。

![配置聚合模型计费](./images/my-aggregate-billing-configuration-add.png)
