...
![选择文本模型](./images/manual-select-text-model.png)

上图展示模型选择器。重点比较供应方实例的能力、价格、性能和可用状态。

![文本模型选择参考](./images/select-model.png)
...
![配置文本生成](./images/manual-configure-text.png)
...
| --- | --- | --- | --- | --- |
| 模型 | 必填 | 下拉选择 | `DeepSeek-V4-Flash` | 当前体验的文本模型；初始选择会随账号和可用性变化。 |
| 供应方 | 必填 | 下拉选择 | `Alibaba-china` | 当前模型的供应方实例。 |
