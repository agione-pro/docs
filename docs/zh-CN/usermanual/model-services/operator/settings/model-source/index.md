...
![查看模型来源详情](./images/model-source-details.png)
...
![编辑模型来源](./images/model-source-edit.png)
...
![删除模型来源](./images/model-source-delete.png)
...
下表将页面校验和业务条件分开说明。
页面选填不代表所有模板或上游服务场景都可以省略。

| 字段名称 | 页面校验 | 业务条件 | 字段类型 | 示例 | 说明 |
| --- | --- | --- | --- | --- | --- |
...
| 模板供应方选择 | `选择供应方` 显示目标模型来源 | 重新打开选择控件，核对来源名称、标识和运营方权限 |
