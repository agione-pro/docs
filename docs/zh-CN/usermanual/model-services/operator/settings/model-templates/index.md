...
![模板列表](./images/model-templates-list.png)
...
![查询模板详情](./images/model-templates-details.png)
...
![编辑模板](./images/model-templates-edit.png)
...
![删除模板](./images/model-templates-delete.png)
...
| 模板在模型发布流程中可被选择 | 发布流程的模板下拉框中出现目标项 | 确认模板状态为启用，检查关联元模型和供应方是否可用 |
