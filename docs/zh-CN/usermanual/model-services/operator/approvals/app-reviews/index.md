...
应用审核是应用面向调用方开放前的检查关卡。运营管理员需要确认应用做什么、调用哪些模型、哪些客户或租户可以看到，以及提交信息是否完整，再给出审核结论。
...
页面按审核状态展示应用审核记录，并提供应用名称和类目筛选。列表展示应用名称、类目、所属客户、版本、审核状态、提交时间、审核时间和可用操作。
...
![查询应用审核](./images/app-reviews-list.png)
...
截图重点标注详情页签、审核信息、应用配置、发布渠道和可用审核操作。
