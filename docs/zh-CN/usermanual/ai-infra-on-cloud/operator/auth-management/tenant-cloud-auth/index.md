...
| 术语 | 说明 |
| --- | --- |
| 单个租户授权 | 只把所选云平台授权给指定租户。 |
| 授权所有租户 | 把所选云平台授权给全部租户。 |
| 授权关系 | 租户与云平台之间已保存的可用范围。 |
...
上图展示“租户-云平台授权”列表页面，列出租户名称、租户ID、已授权云平台，并提供按租户搜索、新增授权及行级编辑/删除操作。
...
上图展示“新增租户-云平台授权”弹窗，需选择授权云平台、授权方式（单个租户授权或授权所有租户），并在单租户模式下选定目标租户。
...
上图展示“编辑租户-云平台授权”弹窗，可核对或调整当前租户关联的云平台授权范围。
...
上图展示删除租户云平台授权时的二次确认提示弹窗，确认后将解除该租户对指定云平台的访问权限。
