...
| --- | --- |
| 推理框架 | 承载模型推理服务的运行框架。 |
| 框架版本 | 框架在特定镜像和启动配置下的版本记录。 |
| 发布版本 | 把已维护版本开放给模型配置选择。 |
...
上图展示“推理框架”列表页面，按云平台切换展示框架卡片、框架类型、发布状态，并提供“添加框架”入口。
...
上图展示框架详情抽屉，展示框架标识、版本列表、关联运行镜像及主从节点启动命令配置。
...
上图展示“添加框架”配置表单，包含云账号、地域、框架类型、框架名称、初始版本号及容器启动命令等配置项。
...
上图展示发布框架版本时的确认弹窗，确认后该版本框架即可在模型配置中被引用。
