...
第 3 步选择元模型时，可在以下页面核对模型能力、模态、协议兼容和接入约束。

![选择元模型](./images/meta-model.png)

第 5 步使用以下页面添加云平台和地域组成的部署点。

![添加部署点](./images/add-deployment-point.png)

第 6 步在部署点内选择云账号，并指认该账号下的云上模型。

![指认云上模型](./images/assign-cloud-model.png)

第 7 步选择模型框架、镜像和部署规格，并核对资源与计费信息。

![选择算力方案](./images/select-compute-plan.png)

第 8 步配置模型调用所需的请求地址、方法、请求头和参数。

![添加输出配置](./images/add-output-configuration.png)

第 9 步进入确认页面，提交前统一核对模型来源、部署点、算力方案和输出配置。
