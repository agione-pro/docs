...
| 术语 | 说明 |
| --- | --- |
| 镜像地址 | 镜像仓库中的引用地址，文档只使用占位信息。 |
| 平台架构 | 镜像支持的处理器或运行架构。 |
| 资源池范围 | 允许使用该镜像的云平台和资源池。 |
...
上图展示“推理镜像”列表页面，展示各云平台与地域下的镜像名称、仓库路径、镜像类型及大小，并提供“添加推理镜像”入口。
...
上图展示“添加推理镜像”配置弹窗，需配置云平台、地域、镜像类型（公共/私有）、镜像名称、仓库路径及描述信息。
...
上图展示“编辑推理镜像”配置弹窗，可更新镜像仓库路径及适用描述。
