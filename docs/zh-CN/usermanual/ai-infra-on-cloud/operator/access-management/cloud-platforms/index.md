...
上图展示“接入云平台”主页面，支持按公有云和私有云分类切换查看已接入厂商卡片、搜索平台名称，并提供添加、导入与导出入口。
...
上图展示“添加云平台”弹窗，需选择云平台类型（公有云/私有云）并从平台下拉列表中选定具体厂商后确认添加。
...
上图展示私有云的“编辑云平台”配置弹窗，可维护平台标识、中英文显示名称、平台链接地址及 Logo 图标。
