...
因此，看到“团队成员”“项目”“成员额度”或“Project Key”时，应先判断当前账号是否在对应租户或项目中获得授权，而不是直接扩大 `operator` 权限。更完整的对象关系见[租户、成员、项目与角色设计逻辑](./identity-access-model)。
...
- [租户、成员、项目与角色设计逻辑](./identity-access-model)
