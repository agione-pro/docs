...
| Stage | Key Result |
| --- | --- |
| 1. Confirm boundary | Tenant, member ownership, and responsibilities are clear |
...
| [Members](../../../usermanual/settings/operator/members-roles/members/) | Review member management; use the adjacent Roles page for role configuration and authorization |
