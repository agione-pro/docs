...
![Choose the publication area and deployment method](../../../usermanual/model-services/user/studio/my-models/images/my-published-choose-where-to-publish-add-public.png)
