...
The Images playground works like a model test bench. Select an available image model and provider, enter the input, adjust parameters, and use the result or error message to decide whether to continue with integration.
...
![Images page](./images/images-list.png)
...
![Select image model](./images/manual-select-images-model.png)

The image shows the model selector. Compare provider capability, price, performance, and availability.

![image model selection reference](./images/select-model.png)
...
![Configure image generation](./images/manual-configure-images.png)
